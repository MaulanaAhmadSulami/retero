    ...
    public function run()
    {
        ...
        $reviews = [
            ...
            [
                ...
                'productTitle' => 'Motor anjayyyyyyyyyyyy',
                'productDescription' => 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatibus necessitatibus eos ipsum provident molestiae possimus ea. Eaque dignissimos vitae, eius autem ducimus perspiciatis id, excepturi nisi totam in praesentium odio.',
                'image' => 'dummyStock.png',
                'rating' => 7.5,
            ],
        ];
