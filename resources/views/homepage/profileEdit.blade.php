        ...
        <div class="mx-40">
            <form action="{{ route('user.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-10">
                    ...
                    <input class="shadow border rounded py-2 px-3 w-full" id="username" type="text" name="name"
                        value="{{ Auth::user()->name }}" required>
                </div>

                <div class="mb-10">
                    <label class="block font-ubuntuMonoBold mb-4" for="avatar">Avatar</label>
                    <img class="w-[13%] rounded-full"
                        src="{{ Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : asset('images/dummyStock.png') }}"
                        alt="Profile Avatar">
                    <input class="rounded py-2 w-full" id="avatar" type="file" name="avatar"
                        value="{{ Auth::user()->avatar }}">
                </div>

                <h3 class="font-ubuntuMonoRegular mb-4">If you want to change your password, enter your old and new
                    password below!</h3>

                <div class="mb-10">
                    <label class="block  font-ubuntuMonoBold mb-4" for="password">Old Password</label>
                    <input class="shadow border rounded py-2 px-3 w-full" placeholder="Old Password" id="old_password"
                ...
                <div class="mb-10">
                    ...
                    <input class="shadow border rounded py-2 px-3 w-full" placeholder="New Password" id="new_password"
                ...
                <div class="mb-10">
                    ...
                    <input class="shadow border rounded py-2 px-3 w-full" id="new_password_confirmation"
                ...
                <div class="flex items-center justify-between mb-10">
                    <button id="shadow-btn"
                        class="bg-button text-[#000] py-4 px-4 rounded-lg flex items-center gap-2 mt-2 hover:bg-[#facc15]"
                        type="submit">
