...
<body>
    <div class="container-fluid">
        ...
        <footer class="bg-footer dark:bg-[#000000] border-t-4"> 
                  ...
                  <div class="grid grid-cols-2 gap-8 sm:gap-8 sm:grid-cols-3 py-2">
                      <div>
                          ...
                          <ul class="text-gray-500 dark:text-gray-400 font-medium">
                              ...
                              <li>
                                  <a href="#" class="hover:underline font-ubuntuMonoRegular">Ulasan Komputer</a>
                              </li>
                          </ul>
                      </div>
                      <div>
                          <h2 class="mb-6 text-[25px] font-ubuntuMonoBold text-gray-900 uppercase dark:text-white">Perusahaan</h2>
                          <ul class="text-gray-500 dark:text-gray-400 font-medium">
                              <li class="mb-2">
            ...
            class="w-full p-2 text-center text-[14px] bg-copyright font-ubuntuMonoBold">
            © 2023 Copyright,
